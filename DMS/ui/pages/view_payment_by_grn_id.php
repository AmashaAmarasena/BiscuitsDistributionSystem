...
$all = $supPaymentObject->get_all_by_grn_id();
// print_r( $all);
...
<div class="dashboard-wrapper">
    ...
    <form method="POST" action="">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <h5 class="card-header">Search Sale</h5>
                <div class="card-body">

                    <div class="form-group row">

                        <label for="inputcategory" class=" col-lg-0 col-form-label text-right">Supplier</label>
                        <div class=" col-lg-2">
