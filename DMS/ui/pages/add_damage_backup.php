...
<div class="dashboard-wrapper">
    <form action="add_damage_list.php" method="post" id="adddamageForm">
        <?php
        if (isset($_GET["dr"])) { ?>
            <input id="inputcategory" type="text" name="damage_id" value="<?= $damage['damage_id'] ?>" required="" data-parsley-type="change" placeholder="" class="form-control" <?php } ?> <div class="card">
