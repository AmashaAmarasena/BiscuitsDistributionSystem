...
if(isset($_POST["user_name"])){
    $userObject->user_name=$_POST["user_name"];
    $userObject->user_psswd=$_POST["user_psswd"];
        ...
        <div class="card ">
            ...
            <div class="card-body">
                <form action="login.php" method="POST">
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-lg" name="user_psswd" id="userpsswd" type="password" placeholder="Password">
                    </div>
                    <div class="form-group">
